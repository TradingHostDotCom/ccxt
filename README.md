...
This repository is an AI-powered development scaffold. Fork it, open it in your AI coding tool (Cursor, Claude, Codex), and tell the AI what you want to build. The rules in `.cursor/rules/` teach the AI everything it needs to know about CCXT and TradingHost to help you create a production-quality trading bot.
...
4. **Configure** — copy `config.example.json` to your TradingHost data directory and fill in your API keys
